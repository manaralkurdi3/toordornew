  ...
  children: [
    ...
    Padding(
      ...
      child: Row(
        ...
        children: [
          Container(
            child: Text("انشئ مشروعك الخاص",style: TextStyle(color: ColorCustome.colorblue,fontSize: 15),),
          ),
        ],
      ),
    ),
    ...
    Container(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.start,
        children: [
          Container(child: Text("معلومات المشروع".tr(),style: TextStyle(
      color: ColorCustome.coloryellow,fontSize: 12,
    ),
    ),
          ),
          TextForm(
