class ApiLinks{
  ...
  static const String busineesAppointmentsCancel='${domain}businees/appointments/cancel';
 ...
 static const String createEmployee='${domain}employee/create';//ممكن في غلط في اللينك
 static const String employeeRequestShow='${domain}employee/request/show';
 static const String employeeRequestNumber='${domain}employee/request/number';
 static const String employeeRequestAccept='${domain}employee/request/accept';
 static const String employeeRequestRefuse='${domain}employee/request/refuse';
 static const String employeeCreateWorkHours='${domain}employee/create/workhours';
 ///App
